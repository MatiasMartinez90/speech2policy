...
const ChallengePrincipiantesCategory: NextPage = () => {
  ...
  useEffect(() => {
    console.log('🔍 [challenge-principiantes] authStatus:', authStatus)
    console.log('🔍 [challenge-principiantes] user:', user ? 'PRESENT' : 'NULL')
  }, [authStatus, user])

  // Redirect to signin if not authenticated
  useEffect(() => {
    if (authStatus === 'unauthenticated') {
      console.log('🚪 [challenge-principiantes] Redirecting to /signin (unauthenticated)')
      Router.push('/signin')
    }
  }, [authStatus])
